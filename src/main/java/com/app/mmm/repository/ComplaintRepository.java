...
public interface ComplaintRepository extends JpaRepository<Complaint, Long> {
	...
	@Query("SELECT new com.app.mmm.dto.ComplainToBeSHownOnFeedDTO(c.imageData, c.location, c.status, ci.username) " +
	           "FROM Complaint c " +
	           "JOIN c.citizen ci")
	    List<ComplainToBeSHownOnFeedDTO> findAllComplaintsWithUsername();
}
